  ...
  methods: {
    async agregarCatecumeno() {
      ...
      if (this.formulario.nombres === null) {
        this.error = "Se requiere el nombre del catucumeno";
        this.errores.push(this.error);
      }
      if (this.formulario.apellidos === null) {
        this.error = "Se requiere el apellido del catucumeno";
        this.errores.push(this.error);
      }
      if (this.formulario.ci === null) {
        this.error = "Se requiere el carnet de indentidad del catucumeno";
        this.errores.push(this.error);
      }
      if (this.formulario.fecha_nacimiento === null) {
        this.error = "Se requiere la fecha de nacimiento del catucumeno";
        this.errores.push(this.error);
      }
      if (this.formulario.direccion === null) {
        this.error = "Se requiere la dirección de donde vive el catucumeno";
        this.errores.push(this.error);
      }
